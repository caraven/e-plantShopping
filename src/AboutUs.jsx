...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      unique botanical treasures, all chosen to inspire wellbeing and sustainability. 
      Whether you're looking to purify your 
      air, add a touch of freshness, or start your plant journey, we are here to guide you with expert advice and quality 
      you can trust.
      </p>
